...
require('lazy').setup({
  ...
  --       opts = {
  --         win = {
  --           width = '50%', -- 50% of the editor width
  --         },
  --         input = {}, -- Enhances `ask()`
  ...
  -- Add nerdtree like
  {
    ...
    opts = {
      window = {
        width = '25%', -- set width to 20% of the Neovim window
      },
      filesystem = {
        filtered_items = {
  ...
  -- Add buffers
  {
    ...
    dependencies = {
      'nvim-tree/nvim-web-devicons', -- optional: shows file icons
    },
    config = function()
      require('bufferline').setup {
        options = {
          -- Show numbers on tabs? (optional)
          numbers = 'none', -- or 'ordinal' to show numbers
          -- Close the current buffer without affecting layout
          close_command = 'bdelete! %d',
          right_mouse_command = 'bdelete! %d',
          -- What to do when you click on a tab
          left_mouse_command = 'buffer %d',
          middle_mouse_command = nil,
          -- Indicator for modified buffers
          indicator = {
            style = 'icon', -- or 'underline'
          },
          -- Customize the look (optional)
          style_preset = require('bufferline').style_preset.default,
          -- You can also set a different separator
          separator_style = 'thin', -- or 'slant', 'thick', 'none'
          -- Enable/disable mouse actions
          hover = {
            enabled = true,
            delay = 0,
            reveal = { 'close' },
          },
          -- Don't show buffers that are not listed (like help, etc.)
          show_buffer_icons = true,
          show_buffer_close_icons = true,
          show_close_icon = true,
          show_tab_indicators = true,
          -- Optionally, you can set a custom theme (e.g., 'tokyonight')
          -- theme = 'tokyonight',
        },
      }
      -- Optional: keymaps to navigate buffers
